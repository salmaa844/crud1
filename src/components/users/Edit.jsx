    ...
    <div className="row flex-nowrap">
      ...
      <div className="col py-3">
        ...
        <form onSubmit={setData}>
          <Input error={error} id={'username'} title={'user name'} type={'text'} name={'name'}  handelData={handelData}/>
          <Input error={error} id={'email'} title={'user email'} type={'email'} name={'email'}  handelData={handelData}/>
          <Input error={error} id={'password'} title={'user password'} type={'password'} name={'password'} handelData={handelData}/>
        <div className="mb-3">
